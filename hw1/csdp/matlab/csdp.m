...
%
if (ispc==1)
  info=dos(['/Users/celia/Documents/MATLAB/csdp/bin/csdp ' fname '.dat-s' ' ' fname '.sol'],'-echo');
else
  if (pars.printlevel ~=0)
    info=system(['time csdp ' fname '.dat-s' ' ' fname '.sol']);
  else
    info=system(['/Users/celia/Documents/MATLAB/csdp/bin/csdp ' fname '.dat-s' ' ' fname '.sol']);
  end
end
%
